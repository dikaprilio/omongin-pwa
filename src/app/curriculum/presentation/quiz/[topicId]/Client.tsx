...
// Client component for the presentation quiz
...
export default function QuizClientPage({ topicId }: QuizClientPageProps) {
    // Offset for Presentation (starts at 151)
    const globalId = 150 + topicId;
                ...
                <main className="max-w-lg mx-auto px-4 py-8 sm:py-12">
                    ...
                    >
                        ...
                        <p className="text-gray-600 text-sm mb-8">
                            {percentage >= 80 ? "Exemplary! You have mastered this module's core concepts." :
                                percentage >= 60 ? "Well done! You have a good grasp, but keep a few things in mind." :
                                    "Keep practicing! Your foundation is building up."}
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            <button
                                ...
                                className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-3 bg-orange-600 text-white rounded-xl hover:bg-orange-700 transition-colors font-medium"
                            >
                            ...
                            return (
                                <button
                                    ...
                                    className={`w-7 h-7 rounded-full text-xs font-medium transition-all ${currentIndex === index
                                        ? 'bg-orange-600 text-white ring-2 ring-orange-200 ring-offset-1'
                                        : status === 'correct'
